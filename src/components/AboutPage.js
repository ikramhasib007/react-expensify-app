      ...
      <div className="container row m-0 p-0">
        ...
        <div className="col-md-8 p-4">
          ...
          <div className="d-flex justify-content-around mt-2">
              ...
              <a href="https://www.dropbox.com/s/pwtvnsxl2jh3kcn/IKRAM-UD-DAULA_CV_NEW.pdf?dl=0" title="CV" className="text-secondary" target="_blank"><i className="fas fa-user-circle fa-3x"></i></a>
          </div>
        </div>
      </div>
    </div>
