...
store.dispatch(addExpense({description: 'Gas Bill', amount: 800, createdAt:moment().subtract(15,'d'), note:'Paid through Agrani Bank. Badda Branch, Dhaka, Bangladeh.'}));
store.dispatch(addExpense({description: 'Water Bill', amount: 500, createdAt:moment().subtract(10,'d'), note:'Paid through Agrani Bank. Rampura Branch, Dhaka, Bangladeh.'}));
